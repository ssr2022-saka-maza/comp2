...
private:
    ...
    uint8_t
    _update_step_ready(ssr2::Machine * machine, const ssr2::PS4Value & value, char * buffer);
    uint8_t
    _update_step_forward(ssr2::Machine * machine, const ssr2::PS4Value & value, char * buffer);
#else /* proc_verbose */
