...
int ssr2::PS4USB::begin() {
    return _usb.Init();
}

void ssr2::PS4USB::update() {
    _usb.Task();
}

bool ssr2::PS4USB::connected() {
...
ssr2::PS4Value * ssr2::PS4USB::read() {
    ssr2::PS4Value * value = new ssr2::PS4Value(
        _ps4.getAnalogHat(LeftHatX), _ps4.getAnalogHat(LeftHatY), _ps4.getAnalogHat(RightHatX),
        _ps4.getAnalogHat(RightHatY), _ps4.getButtonPress(UP), _ps4.getButtonPress(RIGHT),
        _ps4.getButtonPress(DOWN), _ps4.getButtonPress(LEFT), _ps4.getButtonPress(TRIANGLE),
        _ps4.getButtonPress(CIRCLE), _ps4.getButtonPress(CROSS), _ps4.getButtonPress(SQUARE),
        _ps4.getButtonPress(L1), _ps4.getAnalogButton(L2), _ps4.getButtonPress(L3),
        _ps4.getButtonPress(R1), _ps4.getAnalogButton(R2), _ps4.getButtonPress(R3),
        _ps4.getButtonPress(PS), _ps4.getButtonPress(SHARE), _ps4.getButtonPress(OPTIONS),
        _ps4.isTouching(0), 0, 0, _ps4.isTouching(1), 0, 0);
